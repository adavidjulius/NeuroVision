...
────────────────────────────────────────
Uses YOLOv8 nano to detect objects in real time.
Returns detections with label, confidence, bounding box, and screen zone.
"""
...
class Detector:
    def __init__(self):
        ...
        self.model = YOLO(YOLO_MODEL)  # auto-downloads on first run (~6MB)
